...
.rrui__input-field__icon {
  position: absolute;
  top: calc(((0.6rem * 3) - ((0.6rem * 3) - 1.5 * 0.6rem)) / 2);
  left: 0;
  width: calc((0.6rem * 3) - 1.5 * 0.6rem);
  height: calc((0.6rem * 3) - 1.5 * 0.6rem);
  pointer-events: none;
  color: #888888; }

.rrui__input-field--with-icon {
  padding-left: calc(((0.6rem * 3) - 1.5 * 0.6rem) + (0.75 * 0.6rem)); }

/* `<input/>` placeholder color. */
/* https://www.w3schools.com/howto/howto_css_placeholder.asp */
/* Chrome, Firefox, Opera, Safari 10.1+ */
/* Won't work for some reason if combined with the IE rules below. */
.rrui__input-field::-webkit-input-placeholder {
  color: #888888;
  /* Firefox */
  opacity: 1; }
...
.rrui__menu-icon--expanded .rrui__menu-icon__bar {
  width: 100%;
  top: calc((100% - 2px) / 2);
  -webkit-transition: width 125ms 0s, top 125ms 0s, -webkit-transform 125ms 125ms;
  transition: width 125ms 0s, top 125ms 0s, -webkit-transform 125ms 125ms;
  -o-transition: width 125ms 0s, top 125ms 0s, transform 125ms 125ms;
  transition: width 125ms 0s, top 125ms 0s, transform 125ms 125ms;
  transition: width 125ms 0s, top 125ms 0s, transform 125ms 125ms, -webkit-transform 125ms 125ms; }
...
.rrui__menu-icon--collapsed .rrui__menu-icon__bar {
  -webkit-transition: top 125ms 125ms, width 125ms 125ms, -webkit-transform 125ms 0s;
  transition: top 125ms 125ms, width 125ms 125ms, -webkit-transform 125ms 0s;
  -o-transition: transform 125ms 0s, top 125ms 125ms, width 125ms 125ms;
  transition: transform 125ms 0s, top 125ms 125ms, width 125ms 125ms;
  transition: transform 125ms 0s, top 125ms 125ms, width 125ms 125ms, -webkit-transform 125ms 0s;
...
.rrui__tooltip--top {
  -webkit-transform: translateY(calc(-1 * 0.5em));
      -ms-transform: translateY(calc(-1 * 0.5em));
          transform: translateY(calc(-1 * 0.5em)); }

.rrui__tooltip--top.rrui__tooltip--after-show {
  -webkit-transform: translateY(calc(-1 * 0.2em));
      -ms-transform: translateY(calc(-1 * 0.2em));
...
.rrui__tooltip--left {
  -webkit-transform: translateX(calc(-1 * 0.5em));
      -ms-transform: translateX(calc(-1 * 0.5em));
          transform: translateX(calc(-1 * 0.5em)); }

.rrui__tooltip--left.rrui__tooltip--after-show {
  -webkit-transform: translateX(calc(-1 * 0.2em));
      -ms-transform: translateX(calc(-1 * 0.2em));
...
.rrui__tooltip--after-show,
.rrui__tooltip--before-hide {
  -webkit-transition: opacity 120ms, -webkit-transform 120ms;
  transition: opacity 120ms, -webkit-transform 120ms;
  -o-transition: opacity 120ms, transform 120ms;
  transition: opacity 120ms, transform 120ms;
  transition: opacity 120ms, transform 120ms, -webkit-transform 120ms; }
