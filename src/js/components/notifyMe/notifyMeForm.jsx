...
const NotifyMeForm = ({
  ...
  >
    <Field
      ...
      placeholder={translations.get("notifyMe_placeholder") || "Email Address"}
    />
    <InputButton
      type="submit"
      value={translations.get("notifyMe_submit") || "Notify Me"}
...
export default reduxForm({
  ...
  withTranslations(NotifyMeForm, [
    "notifyMe_submit",
    "notifyMe_placeholder",
